  ...
  <div class="card">
    <div class="card-body">
      <div class="d-sm-flex justify-content-center justify-content-sm-between py-2">
        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="https://http.cat/100" target="_blank">PatitasVirtuales </a>2023</span>
        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hecho por <a href="https://http.cat/403" target="_blank"> Pablo Nieto </a> :D</span>
      </div>
    </div>
  </div>
</footer>
